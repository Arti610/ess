...
const ApplyLE = () => {
  ...
  const lateEarly = [
    {key: 'Late Comming', value: 'Late Comming'},
    {key: 'Early Going', value: 'Early Going'},
  ];
  ...
  const handlePress = async values => {
    ...
    fData.append(
      'time',
      formValues.time ? moment(formValues.time).format('HH:mm:ss') : null,
    );
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              {showFromDatePicker && (
                <DateTimePicker
                  value={
                    formValues.date ? new Date(formValues.date) : new Date()
                  }
                  mode="date"
            ...
            <View style={styles.inputContainer}>
              ...
              <TouchableOpacity
                ...
                <Text>
                  {formValues.time
                    ? moment(formValues.time).format('HH:mm:ss')
                    : 'Select Time'}
                </Text>
              </TouchableOpacity>
              {showTime && (
